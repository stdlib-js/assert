...
*/
setReadOnly( ns, 'hasFloat16ArraySupport', require( './../has-float16array-support' ) );
...
*/
setReadOnly( ns, 'hasHasInstanceSymbolSupport', require( './../has-has-instance-symbol-support' ) );
...
*/
setReadOnly( ns, 'hasIsConcatSpreadableSymbolSupport', require( './../has-is-concat-spreadable-symbol-support' ) );
...
/**
* @name hasPromiseSupport
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/has-promise-support}
*/
setReadOnly( ns, 'hasPromiseSupport', require( './../has-promise-support' ) );
...
*/
setReadOnly( ns, 'hasSplitSymbolSupport', require( './../has-split-symbol-support' ) );
...
*/
setReadOnly( ns, 'isAlmostEqual', require( './../is-almost-equal' ) );
...
*/
setReadOnly( ns, 'isAlmostEqualArray', require( './../is-almost-equal-array' ) );
...
*/
setReadOnly( ns, 'isAlmostEqualComplex64array', require( './../is-almost-equal-complex64array' ) );
...
*/
setReadOnly( ns, 'isAlmostEqualComplex128array', require( './../is-almost-equal-complex128array' ) );
...
*/
setReadOnly( ns, 'isAlmostEqualFloat32array', require( './../is-almost-equal-float32array' ) );
...
*/
setReadOnly( ns, 'isAlmostEqualFloat64Array', require( './../is-almost-equal-float64array' ) );

/**
* @name isAlmostSameArray
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-array}
*/
setReadOnly( ns, 'isAlmostSameArray', require( './../is-almost-same-array' ) );

/**
* @name isAlmostSameComplex64Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-complex64array}
*/
setReadOnly( ns, 'isAlmostSameComplex64Array', require( './../is-almost-same-complex64array' ) );

/**
* @name isAlmostSameComplex128Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-complex128array}
*/
setReadOnly( ns, 'isAlmostSameComplex128Array', require( './../is-almost-same-complex128array' ) );

/**
* @name isAlmostSameFloat32Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-float32array}
*/
setReadOnly( ns, 'isAlmostSameFloat32Array', require( './../is-almost-same-float32array' ) );

/**
* @name isAlmostSameFloat64Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-float64array}
*/
setReadOnly( ns, 'isAlmostSameFloat64Array', require( './../is-almost-same-float64array' ) );
...
*/
setReadOnly( ns, 'isAlmostSameValue', require( './../is-almost-same-value' ) );
...
*/
setReadOnly( ns, 'isEqualBooleanArray', require( './../is-equal-booleanarray' ) );
...
*/
setReadOnly( ns, 'isEqualDateObject', require( './../is-equal-date-object' ) );
...
*/
setReadOnly( ns, 'isEqualInt8Array', require( './../is-equal-int8array' ) );
...
*/
setReadOnly( ns, 'isEqualInt16Array', require( './../is-equal-int16array' ) );
...
*/
setReadOnly( ns, 'isEqualInt32Array', require( './../is-equal-int32array' ) );
...
*/
setReadOnly( ns, 'isEqualUint8Array', require( './../is-equal-uint8array' ) );
...
*/
setReadOnly( ns, 'isEqualUint8ClampedArray', require( './../is-equal-uint8clampedarray' ) );
...
*/
setReadOnly( ns, 'isEqualUint16Array', require( './../is-equal-uint16array' ) );
...
*/
setReadOnly( ns, 'isEqualUint32Array', require( './../is-equal-uint32array' ) );
...
*/
setReadOnly( ns, 'isFloat16Array', require( './../is-float16array' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-int64}
*/
setReadOnly( ns, 'isInt64', require( './../is-int64' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-int64array}
*/
setReadOnly( ns, 'isInt64Array', require( './../is-int64array' ) );
...
/**
* @name isndarrayDescriptor
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-ndarray-descriptor}
*/
setReadOnly( ns, 'isndarrayDescriptor', require( './../is-ndarray-descriptor' ) );
...
*/
setReadOnly( ns, 'isNegativeFinite', require( './../is-negative-finite' ) );
...
*/
setReadOnly( ns, 'isNonPositiveFinite', require( './../is-nonpositive-finite' ) );
...
*/
setReadOnly( ns, 'isPositiveFinite', require( './../is-positive-finite' ) );
...
*/
setReadOnly( ns, 'isRaggedNestedArray', require( './../is-ragged-nested-array' ) );
...
*/
setReadOnly( ns, 'isSameAccessorArray', require( './../is-same-accessor-array' ) );
...
*/
setReadOnly( ns, 'isSameArrayLikeObject', require( './../is-same-array-like-object' ) );
...
*/
setReadOnly( ns, 'isSameTypedArrayLike', require( './../is-same-typed-array-like' ) );
...
*/
setReadOnly( ns, 'isStruct', require( './../is-struct' ) );
...
*/
setReadOnly( ns, 'isStructConstructorLike', require( './../is-struct-constructor-like' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-uint64}
*/
setReadOnly( ns, 'isUint64', require( './../is-uint64' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-uint64array}
*/
setReadOnly( ns, 'isUint64Array', require( './../is-uint64array' ) );
...
*/
setReadOnly( ns, 'isWellFormedString', require( './../is-well-formed-string' ) );
