...
*/
setReadOnly( ns, 'isAlmostSameValueArray', require( './../is-almost-same-value-array' ) );

/**
* @name isAlmostSameValueComplex64Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value-complex64array}
*/
setReadOnly( ns, 'isAlmostSameValueComplex64Array', require( './../is-almost-same-value-complex64array' ) );

/**
* @name isAlmostSameValueComplex128Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value-complex128array}
*/
setReadOnly( ns, 'isAlmostSameValueComplex128Array', require( './../is-almost-same-value-complex128array' ) );

/**
* @name isAlmostSameValueFloat32Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value-float32array}
*/
setReadOnly( ns, 'isAlmostSameValueFloat32Array', require( './../is-almost-same-value-float32array' ) );
...
*/
setReadOnly( ns, 'isAlmostSameValueFloat64Array', require( './../is-almost-same-value-float64array' ) );
