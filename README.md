...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert@v0.3.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert/actions/workflows/test.yml/badge.svg?branch=v0.3.2
[test-url]: https://github.com/stdlib-js/assert/actions/workflows/test.yml?query=branch:v0.3.2
