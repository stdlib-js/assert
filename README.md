...
<!-- <toc pattern="is-+(browser|darwin|electron|electron-main|electron-renderer|little-endian|node|web-worker|windows)" > -->
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/assert
