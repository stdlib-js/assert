...
```javascript
var isAlmostSameComplex128Array = require( '@stdlib/assert/is-almost-same-complex128array' );
```

#### isAlmostSameComplex128Array( v1, v2, maxULP )
...
var bool = isAlmostSameComplex128Array( x, y, 0 );
// returns false

bool = isAlmostSameComplex128Array( x, y, 1 );
// returns true

bool = isAlmostSameComplex128Array( x, [ 1.0, 2.0 ], 1 );
// returns false
```
...
var out = isAlmostSameComplex128Array( x, y, 0 );
console.log( out );
// => true

x = new Complex128Array( [ -0.0, 0.0, -0.0, 0.0 ] );
y = new Complex128Array( [ 0.0, -0.0, 0.0, -0.0 ] );
out = isAlmostSameComplex128Array( x, y, 0 );
console.log( out );
// => false
