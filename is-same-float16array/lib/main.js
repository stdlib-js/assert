...
* // returns false
*/
function isSameFloat16Array( v1, v2 ) {
	return ( isFloat16Array( v1 ) && isFloat16Array( v2 ) && hasSameValues( v1, v2 ) ); // eslint-disable-line max-len
}


// EXPORTS //

module.exports = isSameFloat16Array;
