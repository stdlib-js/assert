...
tape( 'the command-line interface tests if a position in a string marks the start of a UTF-16 surrogate pair', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'--pos=0\'; process.argv[ 3 ] = \'🌷\'; require( \''+fpath+'\' );"'
	];
