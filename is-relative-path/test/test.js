...
tape( 'if platform is POSIX, main export is method to test if a string is a POSIX relative path', function test( t ) {
	...
	t.strictEqual( isRelativePath, isRelativePath.posix, 'equals posix method' );
	t.end();
});
