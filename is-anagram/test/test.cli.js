...
tape( 'the command-line interface tests if a string argument is an anagram', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'bat\'; process.argv[ 3 ] = \'--str=tab\'; require( \''+fpath+'\' );"'
	];
