...
tape( 'the command-line interface tests if a string is a valid semantic version', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'0.1.0\'; require( \''+fpath+'\' );"'
	];
