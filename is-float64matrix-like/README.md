...
-   [`@stdlib/assert/is-float32matrix-like`][@stdlib/assert/is-float32matrix-like]: https://github.com/stdlib-js/assert/tree/main/is-float32matrix-like`][@stdlib/assert/is-float32matrix-like
