...
tape( 'the command-line interface tests if a value is a startcase string', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'BeepBoop\'; require( \''+fpath+'\' );"'
	];
