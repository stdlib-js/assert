...
* var y = [ 1.0, 2.0, 4.0 ];
*
* var out = isAlmostSameArray( x, y, 1 );
* // returns false
*/
function isAlmostSameArray( v1, v2, maxULP ) {
	return ( isArray( v1 ) && isArray( v2 ) && hasAlmostSameValues( v1, v2, maxULP ) ); // eslint-disable-line max-len
}


// EXPORTS //

module.exports = isAlmostSameArray;
