...
tape( 'the command-line interface tests if a string argument consists only of numeric digits', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'0123456789\'; require( \''+fpath+'\' );"'
	];
