...
var hasAsyncIteratorSymbol = ( typeof Symbol === 'function' && typeof Symbol.asyncIterator === 'symbol' );
...
tape( 'if `Symbol.asyncIterator` is supported, detection result is `true`', function test( t ) {
